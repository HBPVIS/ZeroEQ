...
if(PKG_CONFIG_EXECUTABLE)
  ...
  if((NOT capnproto_FOUND) AND (NOT CAPNPROTO_FOUND))
    pkg_check_modules(capnproto capnproto)
  endif()
  if((NOT capnproto_FOUND) AND (NOT CAPNPROTO_FOUND))
    message(FATAL_ERROR "Could not find capnproto")
  endif()
else()
...
if(PKG_CONFIG_EXECUTABLE)
  ...
  if((NOT Boost_FOUND) AND (NOT BOOST_FOUND))
    message(FATAL_ERROR "Could not find Boost COMPONENTS unit_test_framework program_options")
  endif()
else()
...
if(libzmq_name)
  list(APPEND FIND_PACKAGES_DEFINES VISEDA_USE_LIBZMQ)
...
if(CAPNPROTO_FOUND)
  set(capnproto_name CAPNPROTO)
  set(capnproto_FOUND TRUE)
elseif(capnproto_FOUND)
  set(capnproto_name capnproto)
  set(CAPNPROTO_FOUND TRUE)
endif()
if(capnproto_name)
  list(APPEND FIND_PACKAGES_DEFINES VISEDA_USE_CAPNPROTO)
  set(FIND_PACKAGES_FOUND "${FIND_PACKAGES_FOUND} capnproto")
  link_directories(${${capnproto_name}_LIBRARY_DIRS})
  if(NOT "${${capnproto_name}_INCLUDE_DIRS}" MATCHES "-NOTFOUND")
    include_directories(SYSTEM ${${capnproto_name}_INCLUDE_DIRS})
  endif()
endif()
...
if(flatbuffers_name)
  list(APPEND FIND_PACKAGES_DEFINES VISEDA_USE_FLATBUFFERS)
...
if(Boost_name)
  list(APPEND FIND_PACKAGES_DEFINES VISEDA_USE_BOOST)
...
if(Lunchbox_name)
  list(APPEND FIND_PACKAGES_DEFINES VISEDA_USE_LUNCHBOX)
