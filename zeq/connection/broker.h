 ...
 * port. The zeq::Publisher side uses the Service to subscribe the remote
 * zeq::Subscriber to the publisher in the absence of zeroconf, e.g., when
...
public:
     ...
     */
    ZEQ_API Broker( const std::string& name, Receiver& receiver,
